            ...
            <div class="wrap" v-for="(item,index) in subjects" :key="index" >
                ...
                <div class="info">
                    ...
                    <div class="wantsee" @click.stop="wanttosee(index)">
                        <div class="wrap">
                            <span class="icon iconfont icon-yduishoucangkongxin" :class="item.subject.has_video?'icon-yduishoucangshixin':'icon-yduishoucangkongxin'"></span>
                            <span class="text">{{item.subject.has_video?"已想看":"想看"}}</span>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        wanttosee(index){
            ...
            this.subjects[index].subject.has_video = !this.subjects[index].subject.has_video;
        }
    },
    mounted(){
        this.initData(()=>{
